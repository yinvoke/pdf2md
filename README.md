...
**全量转换**（11 篇，含 4 篇 A 股 + 7 篇港股）：

| 文档 | 类型 | 页数 | 字符数 | 耗时 | 页/秒 | OCR 回退 |
|------|------|------|--------|------|-------|---------|
| 燕京啤酒_2024年年报 | A股 | 202 | 391,879 | 72.7s | 2.78 | — |
| 燕京啤酒_2025年半年报 | A股 | 136 | 282,279 | 54.8s | 2.48 | — |
| 新和成_2024年年报 | A股 | 189 | 439,786 | 81.8s | 2.31 | — |
| 长江电力_2024年年报 | A股 | 262 | 490,695 | 92.9s | 2.82 | — |
| 小米_2025年年报 | 港股 | 59 | 80,431 | 13.6s | 4.33 | — |
| 小米_2025年Q3 | 港股 | 48 | 77,444 | 17.2s | 2.79 | — |
| 长和_2024年年报 | 港股 | 183 | 430,425 | 83.5s | 2.19 | — |
| 小米_2025年半年报 | 港股 | 127 | 159,029 | 103.3s | 1.23 | ✅ |
| 小米_2024年年报 | 港股 | 379 | 411,280 | 330.7s | 1.15 | ✅ |
| 小米_2023年年报 | 港股 | 347 | 356,260 | 302.1s | 1.15 | ✅ |

> 标准模式 ~2.3-4.3 页/秒；OCR 回退模式（CID 字体自动检测）~1.15-1.23 页/秒，速度较慢但确保正确输出。
>
> 11 篇合计 **3,200,698 字符**，乱码率 **0%**。

**章节过滤效果**（`convert_report`，仅对 A 股年报/半年报生效）：

| 文档 | 模式 | 章节 (保留/总) | 页数 (节约) | 字符数 | 耗时 | 节约字符 | 节约时间 |
|------|------|---------------|------------|--------|------|---------|---------|
| 燕京啤酒_2024年年报 | convert | — | 202 | 391,879 | 72.7s | — | — |
| | convert_report | 3/10 | 155 (-23.3%) | 304,878 | 60.4s | **-87,001 (-22.2%)** | **-12.3s (-16.9%)** |
| 燕京啤酒_2025年半年报 | convert | — | 136 | 282,279 | 54.8s | — | — |
| | convert_report | 3/9 | 117 (-14.0%) | 230,256 | 50.2s | **-52,023 (-18.4%)** | **-4.6s (-8.4%)** |
| 新和成_2024年年报 | convert | — | 189 | 439,786 | 81.8s | — | — |
| | convert_report | 3/10 | 151 (-20.1%) | 348,627 | 65.2s | **-91,159 (-20.7%)** | **-16.6s (-20.3%)** |
| 长江电力_2024年年报 | convert | — | 262 | 490,695 | 92.9s | — | — |
| | convert_report | 3/9 | 210 (-19.8%) | 378,347 | 75.5s | **-112,348 (-22.9%)** | **-17.5s (-18.8%)** |

> 4 篇 A 股报告合计节约 **342,531 字符 (21.3%)**，转换耗时平均减少 **~16%**。港股财报无 `第X节` 章节结构，`convert_report` 自动 fallback 为全量转换。
